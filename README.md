...
แต่ในกรณีที่ใช้ aiStandard หรือ aiStandardSurface ผลจะตรงกันข้าม คืออัลฟาแม็ปจะไม่แสดงผลใดๆในวิวพอร์ต แต่พอเรนเดอร์ออกมาก็จะเห็นผล
...
บางครั้งไฟล์ที่ได้ออกมาหากนำไปเปิดใน MMD ทันทีแล้วจะมีปัญหาขึ้นมา สามารถแก้ได้ด้วยการนำไปเปิดใน pmd อีดิเตอร์ แล้วบันทึกใหม่
