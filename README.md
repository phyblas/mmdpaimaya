...
## ส่รายละเอียดปลีกย่อยอื่นๆ
- ชื่อของโหนดต่างๆจะถูกตั้งโดยดึงชื่อจากในโมเดลเดิม โดยหากชื่อไหนที่เป็นภาษาญี่ปุ่นจะถูกแปลงเป็นโรมาจิโดย pykakasi
- หากนำโมเดลเดิมเข้ามาภายในฉากซ้ำกันวัสดุและเท็กซ์เจอร์จะใช้อันเดียวกัน ไม่ได้สร้างใหม่
